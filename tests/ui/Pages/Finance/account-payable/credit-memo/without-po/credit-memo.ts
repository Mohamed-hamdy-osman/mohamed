...
export class CreditInvoicePage {

  readonly page: Page;

  readonly createBtn: Locator;
  readonly creditBtn: Locator;
  ...
  constructor(page: Page) {
    ...
    this.creditBtn = page.getByRole('button', { name: 'Credit' });
...
this.invoiceType = page.locator('small').filter({ hasText: 'Credit' });
