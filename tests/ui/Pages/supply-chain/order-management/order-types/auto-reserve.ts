 ...
 * Variant: Auto Reservation (Pick Release = Auto Reservation).
 */
export class autoReservationOrderTypePage {
  readonly page: Page;
  ...
  readonly autoReservationRadio: Locator;
  ...
  constructor(page: Page) {
    ...
    this.autoReservationRadio = this.dialog.getByRole('radio', { name: 'Auto Reservation', exact: true });
  ...
  /** Generates a name like "Auto Reserve 482" */
  static generateOrderName(prefix = 'Auto Reserve'): string {
  ...
  async selectAutoReservation() {
    await this.autoReservationRadio.click();
  }
  ...
  /** Full "auto reservation" happy-path flow, returns the generated order name */
  async createAutoReservationOrderType(branchName = 'Cairo Branch'): Promise<string> {
    const orderName = autoReservationOrderTypePage.generateOrderName();
