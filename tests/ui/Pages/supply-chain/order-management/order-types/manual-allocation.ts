 ...
 */
export class manualAllocationOrderTypePage {
  readonly page: Page;
  ...
  /** Full "manual allocation" happy-path flow, returns the generated order name */
  async createManualAllocationOrderType(branchName = 'Cairo Branch'): Promise<string> {
    const orderName = manualAllocationOrderTypePage.generateOrderName();
