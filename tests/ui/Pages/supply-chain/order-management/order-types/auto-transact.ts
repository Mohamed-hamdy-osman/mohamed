 ...
 * Variant: Auto Transaction (Pick Release = Auto Transaction).
 */
export class autoTransactOrderTypePage {
  readonly page: Page;
  ...
  async createAutoTransactOrderType(branchName = 'Cairo Branch'): Promise<string> {
    const orderName = autoTransactOrderTypePage.generateOrderName();
